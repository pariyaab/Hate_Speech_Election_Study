...
dataset_path = "multitarget_KN_grounded_CN/"
dataset_name = f"multitarget_KN_grounded_CN.csv"

dataset = pd.read_csv(f"{dataset_path}{dataset_name}")

# Preprocess the text column
text_data = " ".join(dataset['hate_speech'].astype(str).tolist())
