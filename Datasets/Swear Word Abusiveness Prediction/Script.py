...
dataset_name = "SWAD v2"
dataset = pd.read_csv(f"{dataset_name}.tsv", sep="\t")
dataset.columns = ["nomber", "Tweets","Label"]
dataset = dataset[dataset['Label'] == "Yes"]

dataset['Tweets'] = dataset['Tweets'].str.replace(' @USER', '')
text_data = " ".join(dataset['Tweets'].astype(str).tolist())
